    ...
    <div class="article__content container container--pall">
      ...
      <div class="container">
        <div id="accordion" class="accordion-container">
          <h4 class="accordion-title open">What are the language requirements for studying in China?</h4>
          <div class="active active-content" style="display: block;">
            <p>
            Most universities in China offer programs taught in English for international students. However, some programs may require proficiency in Mandarin Chinese. It's recommended to check the specific language requirements of the universities and programs you are interested in.
            </p>
          </div>
          <h4 class="accordion-title">How can I apply for scholarships to study in China?</h4>
          <div class="accordion-content" style="display: none;">
            <p>
            There are various scholarships available for international students in China. You can explore scholarship opportunities through government-sponsored programs, such as the Chinese Government Scholarship, or through specific universities and organizations. It's advisable to visit the official websites of these programs and follow their application procedures.
            </p>
          </div>
          ...
          <div class="accordion-content" style="display: none;">
            <p>
            Yes, international students in China are allowed to work part-time during their studies, usually for a limited number of hours per week. However, it's important to note that there may be restrictions and regulations imposed by the university or Chinese authorities. It's best to consult with your university's international student office for guidelines regarding part-time work.
            </p>
          </div>
          <h4 class="accordion-title">What is the cost of living for international students in China?</h4>
          <div class="accordion-content" style="display: none;">
            <p>
            The cost of living in China varies depending on the city and lifestyle choices. Generally, living expenses in smaller cities are lower compared to major metropolitan areas like Beijing or Shanghai. As a student, accommodation, meals, transportation, and other daily expenses should be taken into account. It's advisable to research and plan a budget accordingly.
            </p>
          </div>
        </div>
      </div>
